...
import { Product } from '@/typing'   // با P بزرگ
import { Loader } from 'lucide-react'
import React, { useEffect, useState } from 'react'
import ProductCard from './ProductCard'

const AllProduct = () => {
    const [products, setProducts] = useState<Product[] | null>(null)  // با P بزرگ
    ...
    useEffect(() => {
        const getData = async () => {
            setLoading(true)
            try {
                const products: Product[] = await getAllproduct()   // با P بزرگ
